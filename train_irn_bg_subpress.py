import argparse
import os
os.environ["CUDA_VISIBLE_DEVICES"]="4,5,6,7" #"2,3,4,5"
...
def run(args):
    ...
    torch.save(model.module.state_dict(), os.path.join(args.session_name, 'ckpt', f'irn_{args.subpress}.pth'))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--infer_list", default="data/val_voc.txt", type=str)
