import os
# os.environ["CUDA_VISIBLE_DEVICES"]="0" #,1,2,3" # ,2,3" #"0,1,2,3"
...
def train():
    ...
    for ep in range(args.max_epoches):
        ...
        for step, pack in enumerate(train_data_loader):
            ...
            outputs = model.forward(img, valid_mask_lowres, img_raw, label)
            score = outputs['score']
            ...
            # if (optimizer.global_step-1) % args.val_freq == 0 and optimizer.global_step > 2000:
